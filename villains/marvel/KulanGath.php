...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/KulanGath02.jpg" width="500" height="750"><br><br>
			<img src="images/KulanGath01.jpg" width="500" height="755"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Kulan Gath</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Citizen of the city of Yagala during the Hyborian Age.</td>
	</tr>
	<tr>
		<td class="black_cell">Nation or Planet of Origin</td>
	</tr>
	<tr>
		<td class="white_cell">Yagala, Stygia</td>
	</tr>
	<tr>
		<td class="black_cell">Group Affiliation</td>
	</tr>
	<tr>
		<td class="white_cell">(The) N’Garai</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Dark Realm of the N'Garai</p>
			<p>Yagala, Stygia</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mastery of the mystic arts granting ability to cast spells for both offensive and defensive purposes.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Amulet of Kulan Gath:</span> Necklace which contains the spirit of Kulan Gath enabling 
				him to possess and physically alter anyone who wears it.</p><br>
				
				<p><span class="bold">Bone Dragon:</span> Animated skeleton of a flying reptile used for transportation 
				over long distances.</p><br>
			</span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Conan the Barbarian #14 (April, 1972)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Roy Thomas & Barry Windsor-Smith</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Apprenticing under the arch-mage Thoth-Amon; <span class="bold">Kulan Gath</span> was driven out of Stygia 
			for practicing sorcery forbidden even by worshipers of Set.</p><br>
			
			<p>Wandering the ancient world he accumulated mystical knowledge becoming a threat to the kingdoms of the 
			Hyborian Age - and eventually the freedom of the modern world.</p><br>
		</td>
	</tr>
</table>
