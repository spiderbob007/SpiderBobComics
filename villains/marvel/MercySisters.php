...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/MercySisters01.jpg" width="421" height="648"><br><br>
			<img src="images/MercySisters02.jpg" width="322" height="485"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Mercy Sisters</td>
	</tr>
	<tr>
		<td class="black_cell">Nick Name</td>
	</tr>
	<tr>
		<td class="white_cell">Switchblade Sisters</td>
	</tr>
	<tr>
		<td class="black_cell">Civilian ID</td>
	</tr>
	<tr>
		<td class="white_cell">Grace and Mary Mercy</td>
	</tr>
	<tr>
		<td class="black_cell">Occupation</td>
	</tr>
	<tr>
		<td class="white_cell">Murderers</td>
	</tr>
	<tr>
		<td class="black_cell">Legal Status</td>
	</tr>
	<tr>
		<td class="white_cell">Deceased citizens of the United States without criminal records.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Normal humans with excellent hand-to-hand combat skills and marksmanship.</td>
	</tr>
	<tr>
		<td class="black_cell">Accessories</td>
	</tr>
	<tr>
		<td class="white_cell">Civilian weaponry and Volkswagen Beetles.</td>
	</tr>
	<tr>
		<td class="black_cell">Common Enemies</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../heroes/marvel/Deadpool.php" target="_self">Deadpool</a></td>
	</tr>
	<tr>
		<td class="black_cell">Regularly Appearing</td>
	</tr>
	<tr>
		<td class="white_cell">Deadpool Vol. 3</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell">Deadpool Vol. 3 #52 (May, 2001)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Jimmy Palmiotti, Buddy Scalera & Anthony Williams</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Murdering the Heavy Metal/Reggae artist Killer Dick, a reward is posted for the girls dubbed the 
			<span class="bold">"Switchblade Sisters"</span> by the press, and 
			<a href="../../heroes/marvel/Deadpool.php" target="_self">Deadpool</a> aims to collect.</p><br>
		</td>
	</tr>
</table>
