...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Amun01.jpg" width="500" height="750"><br><br>
			<img src="images/Amun02.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> Amun, commonly called the "Hidden One", is the ancient Egyptian god of the air 
			and wind.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Hand of Death</td>
	</tr>
	<tr>
		<td class="black_cell">Civilian ID</td>
	</tr>
	<tr>
		<td class="white_cell">Jon Kasiya</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Sisterhood of the Wasp</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mystically enhanced human with superhuman strength, speed, stamina, agility and durability.</p><br>
			
			<p>Excellent hand-to-hand combatant with skills as a martial artist and assassin.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Ankh Blades:</span> Throwing blades shaped like the ancient Egyptian cross known as 
				the ankh.</p><br>
			</span>	
		</td>
	</tr>
	...
	<tr>
		<td class="white_cell"><a href="../../heroes/marvel/Arana.php" target="_self">Araña</a></td>
	</tr>
	<tr>
		<td class="black_cell">Regularly Appearing</td>
	</tr>
	<tr>
		<td class="white_cell">Araña</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stAmun.php" target="_self">Araña #2</a> (April, 2005)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Fiona Avery & Roger Cruz</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Driven by the murder of his father Jon Kasiya became an assassin at a young age. Auditioning his skills with the 
			Sisterhood of the Wasp, he was employed against their adversary Araña assuming the name of the Egyptian god known 
			as the "Hidden One" - <span class="bold">Amun</span>.</p><br>
		</td>
	</tr>
</table>
