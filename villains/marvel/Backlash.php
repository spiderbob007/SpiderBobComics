...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Backlash02.jpg" width="500" height="750"><br><br>
			<img src="images/Backlash01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
	...
	<tr>
		<td class="white_cell">
			<p>Normal human with a genius level intelligence in engineering and weapons design.</p><br>
			
			<p>Excellent hand-to-hand combatant with exceptional skills with both the whip and nunchakus.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Whiplash Uniform:</span> Steel mesh reinforced uniform designed to protect the wearer 
				from an impact comparable to a bullet.</p><br>
				
				<p><span class="bold">Whips:</span> Cybernetically controlled whips which can administer an electric shock 
				cable of stunning a victim or breaking down the molecular structure of solid matter. Whips can be made rigid 
				to convert into nunchakus or vaulting poles.</p><br>
			</span>	
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Iron Man I</td>
	</tr>
	<tr>
		<td class="black_cell">Regularly Appearing</td>
	</tr>
	<tr>
		<td class="white_cell">Iron Man Vol. 1 & 2</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stWhiplash.php" target="_self">Tales of Suspense #97</a> (Jan. 1968)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Beginning a promising carrier as an engineer at Stark International, Mark Scarlotti decided to take a shortcut to 
			prosperity by designing weapons for the criminal cartel known as the Maggia. Eventually deciding their was more money 
			in committing crimes, Scarlotti turned his talents towards designing weapons for himself as 
			<span class="bold">Whiplash</span>.</p><br>
		</td>
	</tr>
</table>
