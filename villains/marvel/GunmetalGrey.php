...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/GunMetalGrey02.jpg" width="453" height="679"><br><br>
			<img src="images/GunMetalGrey01.jpg" width="500" height="761"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Gunmetal Grey</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Normal human with good hand-to-hand combat and firearm skills.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../heroes/marvel/GhostRiderVII.php" target="_self">Ghost Rider IV</a></td>
	</tr>
	<tr>
		<td class="black_cell">Regularly Appearing</td>
	</tr>
	<tr>
		<td class="white_cell">Ghost Rider Vol. 4</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stGunmetalGrey.php" target="_self">Ghost Rider Vol. 4 #2</a> (July, 2001)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Devin Grayson & Trent Kaniuga</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Little is known of the mercenary biker known as <span class="bold">Gunmetal Grey</span> before he was hired by 
			Johnny Blaze to assassinate his alter-ego the demonic 
			<a href="../../heroes/marvel/GhostRiderVII.php" target="_self">Ghost Rider</a>.</p><br>
		</td>
	</tr>
</table>
