...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Morlun01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Morlun</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Energy vampire with superhuman strength, speed, stamina, agility and durability possessing a preternatural 
			ability to track his prey.</p><br>
			
			<p><span class="bold">Note:</span> Morlun apparently only feeds upon superhuman beings that derive their powers 
			from totemistic sources.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stMorlun.php" target="_self">Amazing Spider-Man Vol. 2 #30</a> (June, 2001)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">J. Michael Straczynski & John Romita Jr.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>The origin of the energy vampire called <span class="bold">Morlun</span> is unknown. What is know is that he has 
			hunted for centuries and preys upon superhumans that possess powers of a totemistic nature and he never relents until 
			he has captured and consumed his prey.</p><br>
		</td>
	</tr>
</table>
