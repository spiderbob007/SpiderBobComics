...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/MadMonk02.jpg" width="500" height="749"><br><br>
			<img src="images/MadMonk04.jpg" width="500" height="750"><br><br>
			<img src="images/MadMonk03.jpg" width="500" height="756"><br><br>
			<img src="images/MadMonk01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Mad Monk</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Officially deceased citizen of Hungary.</td>
	</tr>
	<tr>
		<td class="black_cell">Nation or Planet of Origin</td>
	</tr>
	<tr>
		<td class="white_cell">Hungary</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Carlathan Mountains, Hungary</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Vampire with an ability to control the minds of others and alter his form into that of a wolf.</p><br>
			
			<p><span class="bold">Note:</span> The Mad Monk is vulnerable to the element silver.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Giant apes and wolves.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/dc/1stMadMonk.php" target="_self">Detective Comics #31</a> (Sept. 1939)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>The origin of the Hungarian vampire known as the <span class="bold">Mad Monk</span> is unknown. The Mad 
			Monk became an early adversary of the <a href="../../heroes/dc/BatmanI.php" target="_self">Batman</a> when 
			he attempted to draw Bruce Wayne's fiancée Julie Madison into his thrall. Tracking the vampire back to his 
			lair Batman waged a valiant battle eventually defeating the Mad Monk and his femme fatale familiar Dala, 
			with a silver bullet for each.</p><br>
		</td>
	</tr>
</table>
