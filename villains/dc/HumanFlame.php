...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/HumanFlame01.jpg" width="500" height="769"><br><br>
			<img src="images/HumanFlame02.jpg" width="500" height="769"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Human Flame</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Michael "Mike" Miller</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Secret Society of Super Villains</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Cybernetically enhanced human with an ability to project flame.</p><br>
			
			<p><span class="bold">Note:</span> The Human Flame initially utilized a uniform which contained his flame 
			throwers.</p><br> 
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../heroes/dc/MartianManhunter.php" target="_self">Martian Manhunter</a></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/dc/1stHumanFlame.php" target="_self">Detective Comics #274 </a>(Dec. 1959)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Jack Miller & Joe Certa</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mike Miller decided to use his knowledge of engineering and pyrotechnics to create a flame throwing costume to 
			commit crimes. Stopped by the <a href="../../heroes/dc/MartianManhunter.php" target="_self">Martian Manhunter</a>, 
			Miller languished in prison for almost a decade. After serving his prison sentence, Miller went back to a life of 
			crime, eventually becoming an even more powerful <span class="bold">Human Flame</span>.</p><br>
		</td>
	</tr>
</table>
