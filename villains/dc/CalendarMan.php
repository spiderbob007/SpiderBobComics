...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Calendarman01.jpg" width="500" height="749"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Calendar Man</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Julian Gregory Day</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Normal human with skills as a magician.</td>
	</tr>
	<tr>
		<td class="black_cell">Accessories</td>
	</tr>
	<tr>
		<td class="white_cell">Accessories pertaining to days of the year and events on the calendar.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/dc/1stCalendarMan.php" target="_self">Detective Comics #259</a> (Sept. 1958)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Using the stage name Maharajah the Magician, Julian Day arrived in 
			<a href="../../locations/dc/GothamCity.php" target="_self">Gotham City</a> for a five day engagement, which was 
			actually a front for a series of crimes he would commit based on the seasons, as the 
			<span class="bold">Calendar Man</span>.</p><br>
		</td>
	</tr>
</table>
