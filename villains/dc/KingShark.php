...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/KingShark02.jpg" width="500" height="759"><br><br>
			<img src="images/KingShark01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">King Shark</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Meta-human with superhuman strength, speed, stamina, agility and durability possessing attributes of a 
			shark including razor-sharp teeth, enhanced sense of smell and an ability to survive the depths of the ocean.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Superboy Vol. 3</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell">Superboy Vol. 3 #0 (Oct. 1994)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Karl Kesel and Tom Grummett</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Rumor has it that Nanaue is the offspring of a human woman and a shark god belonging to the pantheon of 
			deities worshiped by the aboriginals of Hawaii. His monstrous appearance is a reflection of his dark soul 
			and his voracious appetite. Terrorizing those that live both on the land and in the seas he is know as the 
			deadly <span class="bold">King Shark</span>.</p><br> 
		</td>
	</tr>
</table>
