...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Korsa01.jpg" width="500" height="780"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Korsa</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Korsa Majalis</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Alien being enhanced by extraterrestrial technology granting superhuman strength, speed, stamina, agility 
			and durability capable of flight and surviving the vacuum of space.</p><br> 
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><span class="bold">Korsa Majalis</span> is one of the few survivors of his planet after an attack by the 
			galactic virus known as <a href="../../aliens_races/dc/Viroxx.php" target="_self">Viroxx</a>.</p><br>
			
			<p>Along with a ragtag group of survivors Korsa came to Earth in search of 
			<a href="../../heroes/dc/Superman.php" target="_self">Superman</a>. Thinking the threat defeated Superman is 
			shocked when Lois Lane is assimilated by the galactic virus - a situation which divides his loyalties - a 
			situation which lead to conflict between Korsa and the Man of Steel.</p><br> 
		</td>
	</tr>
</table>
