...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Circe02.jpg" width="500" height="750"><br><br>
			<img src="images/Circe01.jpg" width="398" height="600"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Circe</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Enchantress</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Ancient Greece</td>
	</tr>
	<tr>
		<td class="black_cell">Group Affiliation</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../teams/dc/InjusticeGang.php" target="_self">Injustice Gang</a></td>
	</tr>
	<tr>
		<td class="black_cell">Base of Operations</td>
	</tr>
	<tr>
		<td class="white_cell">Bermuda Triangle</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Enchantress capable of transforming men into the animal that is suitably representative of his inner 
			being.</p><br>
		
			<p>After men are transformed into animals there are Circe's to command.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Elixir Vitae:</span> Serum made of rare and exotic herbs which prolongs life and 
				vitality.</p><br>
			</span>	
		</td>
	</tr>
	...
	<tr>
		<td class="white_cell">Wonder Woman Vol. 1 #305 (July, 1983)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Dan Mishkin & Gene Colan</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A centuries old enchantress kept young and vibrant by an elixir vitae made from rare and exotic herbs, 
			<span class="bold">Circe</span> was reputed for her ability to lure men and transform them into beast.</p><br>
			
			<p>Warned by an oracle that the daughter of <a href="../../heroes/dc/WonderWomanIII.php" target="_self">Hippolyta</a> 
			would be her downfall, she resolved to destroy 
			<a href="../../heroes/dc/WonderWomanI.php" target="_self">Wonder Woman</a>.</p><br>
		</td>
	</tr>
</table>
