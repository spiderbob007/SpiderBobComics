...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Kancer02.jpg" width="500" height="749"><br><br>
			<img src="images/Kancer01.jpg" width="500" height="763"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Kancer</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Parasitic Organism</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Cancerous organism evolved from Kryptonian DNA possessing super-strength, speed, agility, stamina, 
			invulnerability, flight, the ability to dissolve other organisms for nutrition and mass.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><a href="../../cast/dc/KryptoIII.php" target="_self">Krypto III</a></p>
			<p><a href="../../teams/dc/StrikeForceSuperman.php" target="_self">Strike Force Superman</a></p>
	...
	<tr>
		<td class="white_cell">Action Comics #777 (May, 2001)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Joe Kelly & Kano</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>When Superman was infected with a form of 
			<a href="../../vehicles_devices/dc/Kryptonite.php" target="_self">Kryptonite</a> spawned cancer, other members of 
			<a href="../../teams/dc/StrikeForceSuperman.php" target="_self">Strike Force Superman</a> with the aid of Dr. 
			Hamilton were able to extract the organism.</p><br>
			
			<p>Months later Superman followed a rash of mass killings by an adversary capable of stripping the flesh from 
			its victims. When he tracked the monster down it called him "father" and attempted to kill the Man of Steel, 
			who suffered a tremendous beating at the tentacles of <span class="bold">Kancer</span>.</p><br>
		</td>
	</tr>
</table>
