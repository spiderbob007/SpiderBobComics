...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/PiranhaMan01.jpg" width="500" height="761"><br><br>
			<img src="images/PiranhaMan02.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> The Charybdis is a sea monster from ancient Greek mythology that was believed 
			to create whirlpools by sucking in the sea three times a day.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Piranha-Man</td>
	</tr>
	<tr>
		<td class="black_cell">Civilian ID</td>
	</tr>
	<tr>
		<td class="white_cell">Charybdis</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Atlantic Ocean</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">235 lbs.</td>
	</tr>
	<tr>
		<td class="black_cell">Eye Color</td>
	</tr>
	<tr>
		<td class="white_cell">Black - Mutated Red</td>
	</tr>
	<tr>
		<td class="black_cell">Hair Color</td>
	</tr>
	<tr>
		<td class="white_cell">Black - Mutated Bald</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Meta-human with the ability to absorb the latent abilities of others.</p><br>
			
			<p>After absorbing the aquatic abilities of Aquaman, Charybdis developed a telepathic ability to control 
			sea life.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			...
			<p><a href="../../heroes/dc/Dolphin.php" target="_self">Dolphin</a></p>
	...
	<tr>
		<td class="white_cell">Aquaman Vol. 5 #1 (Aug. 1994)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Peter David & Marty Egeland</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Little is know of the aquatic terrorist known as <span class="bold">Charybdis</span> and his wife Scylla. 
			What is known is that in his first confrontation with the sea king 
			<a href="../../heroes/dc/Aquaman.php" target="_self">Aquaman</a> , he stole not only his ability to communicate 
			with sea life but also his hand and possibly his sanity.</p><br>
		</td>
	</tr>
</table>
