...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/DrDestiny01.jpg" width="500" height="760"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Dr. Destiny</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">John Dee</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mystically enhanced human with an ability to invade the dreams of others and manifest them as reality.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Materioptikon:</span> Device containing a ruby talisman of the Lord of Dreams, 
				<a href="../../gods_monsters/dc/SandmanIV.php" target="_self">Morpheus</a>, which could allow the possessor 
				to manifest dreams as reality.</p><br> 
			</span>	
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Justice League of America Vol. 1</p>
	...
	<tr>
		<td class="white_cell">Justice League of America Vol. 1 #5 (June - July, 1961)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A brilliant inventor John Dee first invented an anti-gravity device he used to impersonate 
			<a href="../../heroes/dc/GreenLanternII.php" target="_self">Green Lantern</a> and infiltrate the 
			<a href="../../teams/dc/JLA.php" target="_self">Justice League</a>. After he was defeated and imprisoned he 
			invented the Materioptikon, a device which could make dreams reality as 
			<span class="bold">Dr. Destiny</span>.</p><br>
		</td>
	</tr>
</table>
