...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Scorch01.jpg" width="500" height="750"><br><br>
			<img src="images/Scorch02.jpg" width="500" height="767"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Scorch</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Earth of an alternate reality created by the <a href="Joker.php" target="_self">Joker</a> and 
			<a href="Mxyzptlk.php" target="_self">Mxyzptlk</a>.</p><br> 
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Metahuman with the ability to spontaneously generate fire and control its flame.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><a href="../../heroes/dc/SupergirlIV.php" target="_self">Supergirl IV</a></p>
	...
	<tr>
		<td class="white_cell">Adventures of Superman #582 (Sept. 2000)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">J. M. DeMatteis & Mike Miller</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Little is known of the woman named Aubrey. She escaped from another dimension when the 
			<a href="Joker.php" target="_self">Joker</a> briefly gained the powers of the fifth-dimensional imp, 
			<a href="Mxyzptlk.php" target="_self">Mxyzptlk</a>. Utilizing her abilities to generate and control flame 
			Aubrey turned to a life of crime as the sultry <span class="bold">Scorch</span>.</p><br> 
		</td>
	</tr>
</table>
