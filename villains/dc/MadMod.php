...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/MadMod02.jpg" width="500" height="756"><br><br>
			<img src="images/MadMod01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Mad Mod</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Neil Richards</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Subject of Great Britain with a criminal record.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../teams/dc/TeenTitans.php" target="_self">Teen Titans</a></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Normal human possessing talents as a clothing designer.</td>
	</tr>
	<tr>
		<td class="black_cell">Accessories</td>
	</tr>
	<tr>
		<td class="white_cell">Clothing designed to conceal criminal activities.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Teen Titans Vol. 1 & 2</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../issues/dc/1stMadMod.php" target="_self">Teen Titans Vol. 1 #7</a> (Jan. - Feb. 1967)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A London fashion designer Neil Richards conceived a plot to smuggle illegal goods from Europe to America 
			using the clothing of the rock star Holley Hip.</p><br>
			
			<p>Suspicious of Holley Hip, the U. S. Treasury Department sent the 
			<a href="../../teams/dc/TeenTitans.php" target="_self">Teen Titans</a> to investigate. The rock star was 
			exonerated and the teen heroes exposed the smuggling plot of the <span class="bold">Mad Mod</span>.</p><br>
		</td>
	</tr>
</table>
