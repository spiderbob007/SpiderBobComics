...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Dust01.jpg" width="500" height="681"><br><br>
			<img src="images/Dust03.jpg" width="500" height="759"><br><br>
			<img src="images/Dust02.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> Dust is translated as "turaab" in Arabic.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Sooraya Qadir</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Citizen of Afghanistan</td>
	</tr>
	<tr>
		<td class="black_cell">Nation or Planet of Origin</td>
	</tr>
	<tr>
		<td class="white_cell">Afghanistan</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mutation resulting in the ability to convert body tissue and clothing in to a living silicate (sand).</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Burka:</span> Traditional head-to-toe length robe worn by women in the Middle East.</p><br>
			</span>	
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stDustII.php" target="_self">X-Men Vol. 2 #133</a> (Dec. 2002)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Grant Morrison & Igor Kordey</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Held as a slave by Afghan troops, the mutant Sooraya was rescued by the X-Man, 
			<a href="Wolverine.php" target="_self">Wolverine</a>.</p><br>
			
			<p>When found, she had killed the troops by means unknown for attempting to remove her ceremonial burka. The only 
			word that she would say to her rescuer was "Turaab," which is translated as <span class="bold">Dust</span>.</p><br>
		</td>
	</tr>
</table>
