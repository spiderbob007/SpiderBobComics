...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/OmegaUnknown02.jpg" width="500" height="750"><br><br>
			<img src="images/OmegaUnknown01.jpg" width="495" height="756"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Omega the Unknown</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Alien android from the planet Protarian.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Protarian, Regreb System</p><br>
			
			<p><span class="bold">Note:</span> Although Model X3Z was trained on the planet Srenesk he was constructed on the 
			planet Protarian.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Alien bio-android with superhuman strength, speed, stamina, agility and durability possessing limited psychokinetic 
			and an ability to draw upon psionic energy from the planet's biosphere to create energy blast from his hands.</p><br>
			
			<p><span class="bold">Note:</span> Model X3Z is mute and does not communicate verbally.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Blockbuster I</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Defenders Vol. 1</p>
			<p>Omega the Unknown Vol. 1 & 2</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Omega the Unknown Vol. 1 #1 (March, 1976)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Steve Gerber, Mary Skrenes & Jim Mooney </td>
	</tr>
	<tr>
