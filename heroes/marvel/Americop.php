...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Americop01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Americop</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Bartholomew "Bart" Gallows</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Houston, Texas</td>
	</tr>
	<tr>
		<td class="black_cell">Group Affiliation</td>
	</tr>
	<tr>
		<td class="white_cell">Houston Police Dept.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Normal human with training as a police officer.</p><br>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Americop Uniform:</span> Kevlar body armor, ballistic facemask and customized hardened 
				hat which doubles a s throwing weapon.</p><br>
				
				<p><span class="bold">Customized Pickup Truck:</span> Customized armored truck equipped with police siren and 
				public address system.</p><br>
				
				<p>Weapons common to law enforcement.</p><br>
			</span>	
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stAmericop.php" target="_self">Captain America Vol. 1 #428</a> (June, 1994)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Disillusioned with the law's inability to protect society, Houston police officer Bart Gallows resigned to battle 
			lawlessness on his own terms. Equipped with a bullet-proof uniform of his own design, he traveled the nation meting 
			out vigilante justice as the <span class="bold">Americop</span>.</p><br>
		</td>
	</tr>
</table>
