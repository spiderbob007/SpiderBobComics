...
<table border="1">
	...
	<tr>
		<td class="white_cell">
			<p>Pietro Lensherr and his twin sister Wanda (<a href="ScarletWitch.php" target="_self">Scarlet Witch</a>) are 
			the offspring of the mutant supremacist Erik Lensherr 
			...
			<p>Desperate to win his father's approval, but never winning it, Pietro Lensherr became one of the Brotherhood's 
			lieutenants using his mutant speed to create fear in the human population as 
			<span class="bold">Quicksilver</span>.</p><br>
		</td>
	</tr>
</table>
