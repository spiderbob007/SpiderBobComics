...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/UltimateQuicksilver_ScarletWitch01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Wanda Lensherr</p><br>
			
			<p><span class="bold">Alias</span></p>
			<p>Wanda Maximoff</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Triskelion</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mutation resulting in an ability to manipulate probability to create a wide range of effects. Probability 
			altering powers enable flight, teleportation and transformation of organic and inorganic matter.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Wanda Lensherr and his twin brother Pietro (<a href="Quicksilver.php" target="_self">Quicksilver</a>) are the 
			offspring of the mutant supremacist Erik Lensherr 
			(<a href="../../../villains/marvel/ultimate/Magneto.php" target="_self">Magneto</a>). Abandoning their human mother 
			when they were young, Magneto took his children when he co-founded the Brotherhood of Mutants.</p><br>
			
			<p>Emotionally close to her brother, Wanda Lensherr deferred to her brother in all matters. When Quicksilver sought 
			favor with their father she joined with them against humanity as the <span class="bold">Scarlet Witch</span>.</p><br>
		</td>
	</tr>
</table>
