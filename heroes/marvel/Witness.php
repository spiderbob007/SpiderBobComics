...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Witness01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Witness</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Clairvoyance human with the ability to foresee tragic events which are about to happen to others.</p><br>
			
			<p>Excellent hand-to-hand combatant and marksmen with training as a police detective.</p><br>
	  </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Mystic Comics</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stWitness.php" target="_self">Mystic Comics #7</a> (Dec. 1941)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> Stan Lee used the pen name S.T. Anley</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>An un-named police detective accidentally shot and innocent man in the line of duty and served two years in prison, 
			where he attempted to commit suicide. Before he could kill himself he heard a mysterious voice telling him that it is 
			not yet his time, and charged him with the task of seeing tragedy before it occurs. For several days before tragedy 
			occurs he will watch to judge if the victim is worthy of a second-chance or if he will standby and serve as tragedy's 
			<span class="bold">Witness</p>.<br>
		</td>
	</tr>
</table>
