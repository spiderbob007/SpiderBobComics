...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Speedball01.jpg" width="500" height="759"><br><br>
			<img src="images/Speedball02.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
			<p>Speedball</p>
			<p><a href="PenanceII.php" target="_self">Penance II</a></p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Robert "Robbie" Baldwin</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Springdale, Connecticut</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Avengers Academy</p>
			<p><a href="../../teams/marvel/NewWarriors.php" target="_self">New Warriors</a></p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Normal human altered by an extra-dimensional energy which allows him to absorb and control kinetic energy.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stSpeedball.php" target="_self">Amazing Spider-Man Vol. 1 An. #22</a> (1988)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Steve Ditko & Tom DeFalco</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>As an intern at a research laboratory, Robert Baldwin was accidentally bombarded by energy bubbles from another 
			dimension. When one of a gang of thieves attempting to steal a rare metal from the lab struck Baldwin it activated 
			his powers causing him to ricochet around the room knocking the crooks unconscious. After learning to control his 
			powers Baldwin became the masked adventurer known as <span class="bold">Speedball</span>.</p><br>
		</td>
	</tr>
</table>
