...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/LaughingMask01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
	...
	<tr>
		<td class="white_cell">Dennis Burton</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Normal human with skills as a boxer and marksman.</p><br>
			
			<p>Above average intelligence with skills as a criminal prosecutor.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Handguns:</span> Two semi-automatic pistols.</p><br>
			</span>	
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stLaughingMask.php" target="_self">Daring Mystery Comics #2</a> (Feb. 1940)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Will Harr & Maurice Gutwirth </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Frustrated with the courts ability to prosecute justice against the mafia, Deputy District Attorney Dennis Burton 
			took up arms and disguised himself with a phosphorescent mask assuming the identity of the vigilante known as the 
			<span class="bold">Laughing Mask</span>.</p><br>			
		</td>
	</tr>
</table>
