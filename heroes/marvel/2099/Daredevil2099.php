...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Daredevil2099_01.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Daredevil 2099</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Samuel Fisk</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Citizen of the United States of 2099.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Normal human augmented with an technologically advanced uniform which mimics the powers of the original 
			Daredevil; enabling the ability to perceive objects and movement with a 360 degree radius.</p><br>		
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<span class="left">
				<p><span class="bold">Daredevil Uniform:</span> Armored uniform designed to mimic the powers of the 
				original <a href="../Daredevil.php" target="_self">Daredevil</a>.</p><br>
			</span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Daredevil 2099 #1 (Dec. 2004)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Robert Kirkman, Karl Moline & Mike Perkins</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Samuel Fisk's grandfather Wilson loved to recount stories of his glory days as the most feared man in 
			New York City, known as the <a href="../../../villains/marvel/Kingpin.php" target="_self">Kingpin</a>, and 
			his ultimate victory against the hero known as <a href="../Daredevil.php" target="_self">Daredevil</a>.</p><br>
			
			<p>These stories terrified and sickened the young Fisk, inspiring him to honor his grandfather's fallen foe 
			by becoming a late 21st century <span class="bold">Daredevil</span>.</p><br>
		</td>
	</tr>
</table>
