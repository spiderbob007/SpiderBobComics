...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/NickFury_II_01.jpg" width="500" height="759"><br><br>
			<img src="images/NickFury_II_02.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
 		<td class="white_cell">Colonel Nick Fury II</td>
	</tr>
	<tr>
		<td class="black_cell">Nick Name</td>
	</tr>
	<tr>
 		<td class="white_cell">Nick Fury Jr.</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell">
			<p>Nicholas Joseph "Nick" Fury, Jr.</p><br>
			
			<p><span class="bold">Note:</span> Before discovering that he was the son of 
			<a href="NickFuryCol.php" target="_self">Nick Fury Sr.</a>, Nick Fury Jr. was named Marcus Johnson by his 
			mother.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell">Battle Scars #1 (January 2012)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
 		<td class="white_cell">Matt Fraction, Chris Yost, Scot Eaton, Cullen Bunn, & Paul Neary</td>
	</tr>
	<tr>
