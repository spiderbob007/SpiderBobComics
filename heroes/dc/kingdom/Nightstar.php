...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Nightstar01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Nightstar</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Mar'i Grayson</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> Of human and Tamaranean biology - Mar'i Grayson may have been born on either Earth or Tamaran.</p><br>
    </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> Nightstar is a member of the Titans of an alternate or possible future.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Dark Violet</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Human-Tamaranean hybred with the ability to convert solar energy into flight or channel it as concussive force known as Starbolts. 
			Possibly possesses the ability to absorb language knowledge through physical contacts.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Mar'i Grayson is the beautiful daughter of Dick Grayson (<a href="../NightwingIII.php" target="_self">Nightwing III</a>) 
			and Koriand'r (<a href="../StarfireIII.php" target="_self">Starfire II</a>) in an alternate time-line.</p><br>
			
			<p>Estranged from her father and her mother's whereabouts unknown, she nevertheless fulfills their legacy as the hero 
			<span class="bold">Nightstar.</p><br>
		</td>
	</tr>
</table>
