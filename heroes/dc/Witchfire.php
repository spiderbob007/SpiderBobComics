...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Witchfire01.jpg" width="500" height="765"><br><br>
			<img src="images/Witchfire02.jpg" width="400" height="595"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Witchfire</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Rebecca Carstairs</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Homunculus with knowledge of the occult.</p><br>
			
			<p>Exceptional skills as an actor, acrobat and stunt performer.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A performer of multiple talents, Rebecca Carstairs purchased a scroll of ancient incantations in the Opal City curio shop 
			Knight's Past. Weeks later in a performance at Boston's Fleet Center she used the scroll to summon the demon Nekron. Joined by 
			<a href="WonderWomanI.php" target="_self">Wonder Woman</a> she defeated the demon, but the experience created a link to mystical 
			forces which transformed Carstairs into the sorcerous <span class="bold">Witchfire</span>.</p><br>
		</td>
	</tr>
</table>
