...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/AtomGirl01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">
	...
	<tr>
		<td class="white_cell">Vi</td>
	</tr>
	<tr>
		<td class="black_cell">Civilian ID</td>
	</tr>
	<tr>
		<td class="white_cell">Salu "Vi" Digby</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Biologically typical Imskian with an ability to shrink at will.</p>
			
			<p>Exceptional hand-to-hand combatant with skills of espionage.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/dc/1stShrinkingViolet.php" target="_self">Action Comics #276</a> (May, 1961)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Jerry Siegal & Jim Mooney</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Despite her shyness, Salu Digby decided to apply for membership in the 
			<a href="../../teams/dc/LegionSuperHeroes.php" target="_self">Legion of Super-Heroes</a>, and although failing her trial 
			other successful applicants encouraged her into a second attempt, where she would succeed, assuming the identity of 
			<span class="bold">Shrinking Violet</span>.</p><br>
		</td>
	</tr>
</table>
