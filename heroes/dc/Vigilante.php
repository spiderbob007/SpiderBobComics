...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Vigilante04.jpg" width="500" height="758"><br><br>
			<img src="images/Vigilante03.jpg" width="500" height="757"><br><br>
			<img src="images/Vigilante07.jpg" width="500" height="758"><br><br>
			<img src="images/Vigilante06.jpg" width="500" height="713"><br><br>
			<img src="images/Vigilante05.jpg" width="500" height="812"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Vigilante VI</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Justin "Jay-Jay" Sutter</p><br>
	
			<p><span class="bold">Legal Name</span></p>
			<p>Dr. Justin Powell</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><p><a href="../../locations/dc/Metropolis.php" target="_self">Metropolis</a>, New York</p>
    </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Normal human with skills as a criminal psychologist.</p><br>
			
			<p>Excellent hand-to-hand combatant and marksman.</p><br>
	
			<p><span class="bold">Note:</span> Justin Sutter has a dual personality and originally was unaware of his 
			persona as the Vigilante.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><span class="bold">Vigilante Uniform:</span> Combat uniform equipped with night-vision goggles.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Vigilante Vol. 2</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell">Vigilante Vol. 2 #1 (Nov. 2005)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Bruce Jones & Ben Oliver</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>The sole survivor of the massacre of a summer camp by one of the camp councilors, the young Justin Sutter 
			created a dual personality to cope with the trauma.</p><br>
			
			<p>When he grew to maturity he used the skills he developed as a criminal psychologist to track and exterminate 
			them as the <span class="bold">Vigilante</span>.</p><br>
		</td>
	</tr>
</table>
