...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Monolith04.jpg" width="500" height="759"><br><br>
			<img src="images/Monolith03.jpg" width="500" height="759"><br><br>
			<img src="images/Monolith01.jpg" width="497" height="657"><br><br>
			<img src="images/Monolith05.jpg" width="500" height="750"><br><br>
			<img src="images/Monolith06.jpg" width="500" height="755"><br><br>
			<img src="images/Monolith02.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Monolith</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><span class="bold">Peter</span></p>
			<p>Criminal</p><br>
			
			<p><span class="bold">Monolith</span></p>
			<p>Protector</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Deceased citizen of the United States transformed into a creature animated by mysticism.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Golem with superhuman strength, stamina and durability compelled to punish the guilty.</p><br>
			
			<p><span class="bold">Note:</span> According to Jewish folklore a Golem is an artificially created human 
			composed of mud, stone and blood supernaturally endowed with life.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Monolith #1 (April, 2004)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Jimmy Palmiotti, Justin Gray & Phil Winslade</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Man? Monster? Urban legend... or something more?</p><br>
			
			<p>Created within the immigrant community of New York during the Great Depression of the 1930's, the creature 
			struck a blow for justice in the poorest and most savage part of the city.</p><br>
			
			<p>Decades later, junky and prostitute Alice Cohen inherited her grandmother's Brooklyn home but she also 
			inherited the legacy of a protector known as the <span class="bold">Monolith</span>.</p><br>
		</td>
	</tr>
</table>
