...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Ballistic01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Ballistic</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Kevin Mao</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Blood Pack</p>
			<p>Forgotten Heroes</p>
			<p><a href="../../locations/dc/GothamCityPD.php" target="_self">Gotham City Police</a></p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Normal human genetically altered by an alien parasite granting superhuman strength, speed, an armor plated skin 
			increasing durability and a green membrane over the eyes enabling vision in total darkness.</p><br>
			
			<p>Excellent hand-to-hand combatant with advanced police training.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Batman An. #17 (1994)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Doug Moench & Eduardo Barreto</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A member of the <a href="../../locations/dc/GothamCityPD.php" target="_self">Gotham City Police</a> Tactical Squad, 
			Kevin Mao and his fellow officers were assaulted by the alien parasite Angon.</p><br>
			
			<p>By chance Mao survived the parasites attack and a broken back. Recovering in the hospital, he body began to mutate 
			into a Magenta skinned powerhouse.</p><br>
			
			<p>Teaming with the second Batman, Mao pursued the alien parasite assuming the name <span class="bold">Ballistic</span>.</p><br>
		</td>
	</tr>
</table>
