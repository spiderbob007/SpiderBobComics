...
<table border="1">
	<td class="black_cell">Alias</td>
		<td class="image_cell" rowspan="100%">
			<img src="images/GahLakTus02.jpg" width="500" height="745"><br><br>
			<img src="images/GahLakTus01.jpg" width="500" height="750"><br>
		</td>
	</tr>
  	<tr>
		<td class="white_cell">Gah Lak Tus</td>
	</tr>
  	<tr>
  	...
  	<tr>
		<td class="white_cell">Unknown - Possibly Inapplicable</td>
	</tr>
  	<tr>
		<td class="black_cell">Occupation</td>
	</tr>
  	<tr>
		<td class="white_cell">Destroyer of Life</td>
	</tr>
  	<tr>
  	...
  	<tr>
		<td class="white_cell">~100,000 miles</td>
	</tr>
  	<tr>
  	...
  	<tr>
		<td class="white_cell">Alien robotic entity of immeasurable power capable of destroying entire planets.</td>
	</tr>
  	<tr>
  	...
  	<tr>
		<td class="white_cell">Ultimate Extinction</td>
	</tr>
  	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
  	<tr>
		<td class="white_cell">Ultimate Extinction #1 (2006)</td>
	</tr>
  	<tr>
