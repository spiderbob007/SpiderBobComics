...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Modulus01.jpg" width="500" height="750"><br><br>
			<img src="images/Modulus02.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Modulus</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Sentient mathematical equation.</td>
	</tr>
	<tr>
		<td class="black_cell">Legal Status</td>
	</tr>
	<tr>
		<td class="white_cell">Sentient electrochemical being from another dimension.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Sentient mathematical equation with the ability to rearrange matter and energy on a molecular level.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Fantastic Four Vol. 3 #62 (Dec. 2002)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Mark Waid & Mike Wieringo</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A electrochemical being evolved from the mathematical equations of Reed Richards 
			(<a href="../../heroes/marvel/MrFantastic.php" target="_self">Mr. Fantastic</a>) stored like a computer 
			hard drive within a pocket dimension.</p><br>
		
			<p>Freed from its dimension the living equation sought to eliminate all obstacles competing from its 
			creator's affections, by eliminating the Fantastic Four.</p><br>
		</td>
	</tr>
</table>
