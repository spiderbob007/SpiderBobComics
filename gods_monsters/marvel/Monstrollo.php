...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Monstrollo01.jpg" width="500" height="750"><br><br>				
			<img src="images/Monstrollo_Manoo_Bombu01.jpg" width="500" height="750"><br>				
		</td>
	</tr>
	<tr>
		<td class="white_cell">Monstrollo</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Mechanism</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Artificial being with mechanically superior strength and durability.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/marvel/1stMonstrollo.php" target="_self">Tales of Suspense Vol. 1 #25</a> (Jan. 1962)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Jack Kirby & Dick Ayers</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Famous movie producer Charles Hudson created for his next feature film an advanced robot he dubbed 
			"<span class="bold">Monstrollo</span>." When revealed, the public turned against his creation and film 
			as being too frightening for the youth of the nation. Hudson resolved to dismantle the robot, but before 
			he could do so an alien armada invaded the Earth. Using his giant automaton to drive the invaders back 
			to space, Hudson became an unsung savior of the Earth.</p><br>
		</td>
	</tr>
</table>
