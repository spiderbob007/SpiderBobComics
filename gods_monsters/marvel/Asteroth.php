...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Asteroth01.jpg" width="500" height="745"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Asteroth</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Devourer of Universes</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Extra-dimensional Galaxy</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Shape-shifting demonic entity capable of consuming entire universes.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../heroes/marvel/BetaRayThor.php" target="_self">Beta Ray Thor</a></td>
	</tr>
	<tr>
		<td class="black_cell">Regularly Appearing</td>
	</tr>
	<tr>
		<td class="white_cell">Stormbreaker</td>
	</tr>
	<tr>
		<td class="black_cell">First Appearance</td>
	</tr>
	<tr>
		<td class="white_cell">Stormbreaker #3 (May, 2005)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Michael Avon Oeming, Dan Berman & Andrea Divito</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>When Stardust, the herald of <a href="Galactus.php" target="_self">Galactus</a>, battled 
			<a href="../../heroes/marvel/BetaRayThor.php" target="_self">Beta Ray Thor</a> to a stalemate, the alien 
			opened a dimensional portal in hopes of trapping the Korbinite hero within a demon infested hell. Caught 
			in the dark tendrils of a demon Beta Ray Thor used his hammer Stormbreaker to sever the limb from the 
			larger body of an unseen mass on the other side of the dimensional breach. This relatively small mass 
			took form into a demon bent on consuming yet another dimension - a horror called 
			<span class="bold">Asteroth.</p><br>
		</td>
	</tr>
</table>
