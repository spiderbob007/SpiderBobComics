				...
				<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 900px; height: 100px; overflow: hidden;">
					<div>
					   <img u=image src="images/banner/01.png" />
						<div u="thumb">A timeline documenting the history of comics...</div>
					</div>
					<div>
					   <img u=image src="images/banner/02.png" />
						<div u="thumb">from the golden-age until today.</div>
					</div>
					<div>
					   <img u=image src="images/banner/03.png" />
						<div u="thumb">Origins of your favorite publishers.</div>
					</div>
					<div>
					   <img u=image src="images/banner/04.png" />
						<div u="thumb">Origins of your favorite characters.</div>
					</div>					
					<div>
					   <img u=image src="images/banner/05.png" />
						<div u="thumb">Censorship of an industry.</div>
					</div>
					<!--div>
					   <img u=image src="images/banner/06.png" />
						<div u="thumb">The ups and downs of the comics publishing business.</div>
					</div>
					<div>
					   <img u=image src="images/banner/07.png" />
						<div u="thumb">The only constant is change.</div>
					</div -->
					<div>
