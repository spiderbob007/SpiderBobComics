...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Livewires01.jpg" width="500" height="764"><br><br>
			<img src="images/Livewires02.jpg" width="500" height="766"><br><br>
			<img src="images/Livewires03.jpg" width="500" height="709"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Livewires</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Artificial life-forms designed for espionage operations.</td>
	</tr>
	<tr>
		<td class="black_cell">Legal Status</td>
	</tr>
	<tr>
		<td class="white_cell">Property of <a href="SHIELD.php" target="_self">S.H.I.E.L.D.</a></td>
	</tr>
	<tr>
		<td class="black_cell">Nation or Planet of Origin</td>
	</tr>
	<tr>
		<td class="white_cell">Constructed in the United States.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Livewires #1 (2005)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Adam Warren & Rick Mays</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Dubbed Project <span class="bold">Livewire</span>, a top-secret government initiative which designed a series of 
			next-generation humanoid androids to infiltrate and eliminate the enemies of the nation. Instead of the androids going rogue and 
			pursuing their own agenda the entire project went rogue and began targeting other programs both within and outside of the government.</p><br>
		</td>
	</tr>
</table>
