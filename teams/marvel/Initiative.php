...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Initiative01.jpg" width="500" height="750"><br><br>
			<img src="images/Initiative03.jpg" width="500" height="720"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">(The) Initiative</td>
	</tr>
	<tr>
		<td class="black_cell">Nick Name</td>
	</tr>
	<tr>
		<td class="white_cell">Fifty State Initiative</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><a href="../../heroes/marvel/3D_Man.php" target="_self">3-D Man</a></p>
			<p>Annex</p>
			<p>Ant-Man III</p>
			<p>Baron Von Blitzschlag</p>
			<p>Batwing</p>
			<p>Boulder</p>
			<p>Catwalk</p>
			<p>Cloud 9</p>
	...
	<tr>
		<td class="white_cell">Government sanctioned and funded superhuman military training center.</td>
	</tr>
	<tr>
		<td class="black_cell">Legal Status</td>
	</tr>
	<tr>
		<td class="white_cell">Sanctionedd and funded by the United States Government.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Camp Hammond, Stamford, Connecticut</p><br>
		
			<p><span class="bold">Note:</span> Each team in the Fifty State Initiative is based from different locations, but all cadets train at the Camp Hammond site.</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Resources of the United States Government and individual members.</td>
	</tr>
	<tr>
