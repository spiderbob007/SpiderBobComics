...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/DP7_01.jpg" width="500" height="750"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">DP7</td>
	</tr>
	<tr>
		<td class="black_cell">Nick Name</td>
	</tr>
	<tr>
		<td class="white_cell">Displaced Paranormals-7</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Group of fugitive paranormals.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">ESPeople</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../../issues/marvel/1stDP7.php" target="_self">DP7 Vol. 1 #1</a> (Nov. 1986)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Mark Gruenwald & Paul Ryan</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>After the "White Event" many people found themselves with strange and often frightening paranormal 
			powers. To address the needs of paranormals a clinic was established in Wisconsin by Dr. Philip Nolan 
			Voigt - who had an ulterior motive to supply the CIA with superhuman agents. Discovering Voigt's 
			motivations seven of the patients from therapy group C decided to go on the run - unofficially dubbed 
			<span class="bold">Displaced Paranormals 7</span>.</p><br>
		</td>
	</tr>
</table>
