...
<table border="1">
  <tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/Elite01.jpg" width="500" height="770"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">(The) Elite</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Group of superhuman vigilantes.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><span class="bold">Bunny:</span> Extraterrestrial bacteria colony which serves as an orbital fortress.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Action Comics #775 (March, 2001)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Joe Kelly, Doug Mahnke & Lee Bermejo</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Heroes for a nihilistic era, they dispense justice with extreme force without regard of the consequences or the lives of 
			innocent victims. Challenging the moral code and methods of 
			<a href="../../heroes/dc/Superman.php" target="_self">Superman</a> 
			they set themselves apart from the rest of humanity and society as the <span class="bold">Elite</span>.</p><br>
		</td>
	</tr>
</table>
