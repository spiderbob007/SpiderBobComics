...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/PepperPotts01.jpg" width="500" height="758"><br>
		</td>
	</tr>
	<tr>
 		<td class="white_cell">
			<p>Hera</p>
			<p><a href="../../heroes/marvel/Rescue.php" target="_self">Rescue</a></p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell">Pepper</td>
	</tr>
	<tr>
		<td class="black_cell">Civilian ID</td>
	</tr>
	<tr>
 		<td class="white_cell">Virginia Potts</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell">			
			<p>Stark International</p>
			<p>Avengers Initiative</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell">Normal human with good organizational skills and, intelligence and a quick wit.</td>
	</tr>
	<tr>
		<td class="black_cell">Accessories</td>
	</tr>
	<tr>
 		<td class="white_cell">Resources of Stark International corporation.</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell">
			<p>Iron Man Vol. 1, 2, 3 & 4</p>
			<p>Tales of Suspense Vol. 1 & 2</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
 		<td class="white_cell"><a href="../../issues/marvel/1stPepperPotts.php" target="_self">Tales of Suspense #45</a> (Sept. 1963)</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Virginia <span class="bold">"Pepper"</span> Potts became Tony Stark's personal secretary after she impressed the 
			industrialist by noticing an accounting error that saved him a lot of money.</p><br>
			
			<p>Stark's trust grew in her to the point that he revealed his heroic identity as 
			<a href="../../heroes/marvel/IronManI.php" target="_self">Iron Man</a></p><br>
		</td>
	</tr>
</table>
