...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img src="images/KatFarrell01.jpg" width="500" height="760"><br><br>
			<img src="images/KatFarrell02.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Kat Farrell</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Katherine "Kat" Farrell</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p><a href="../../locations/marvel/DailyBugle.php" target="_self">Daily Bugle</a></p>
			<p>(The) Pulse</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Normal human with skills as an investigative journalist.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Deadline #1 (June, 2002)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Bill Rosemann & Guy Davis</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>A rookie journalist for the <a href="../../locations/marvel/DailyBugle.php" target="_self">Daily Bugle</a>, 
			Kat Farrell was assigned one of the worst beats imaginable - superheroes. While she waited for her opportunity 
			to get noticed by the right people and not be noticed by publisher 
			<a target="_self" href="JJJameson.php" target="_self">J. Jonah Jameson</a>, a strange story fell into her lap which would lead 
			her to discover the mystery of a vengeful spectre known as the 
			<a target="_self" href="../../heroes/marvel/Judge.php" target="_self">Judge</a>.</p><br>
		
			<p>Farrell's efforts and skills as an investigative journalist would eventually be recognized, but ironically 
			her experience resulted in an assignment reporting for the Pulse, the Daily Bugle's supplemental magazine covering 
			the superhuman community.</p><br>
		</td>
	</tr>
</table>
