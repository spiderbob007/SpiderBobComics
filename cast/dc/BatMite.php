...
<table border="1">
	<tr>
		...
		<td class="image_cell" rowspan="100%">
			<img title="Bat-Mite" src="images/BatMite01.jpg" width="500" height="687"><br><br>
			<img title="Bat-Mite" src="images/BatMite03.jpg" width="500" height="773"><br><br>
			<img title="Bat-Mite" src="images/BatMite02.jpg" width="500" height="759"><br>
		</td>
	</tr>
	<tr>
		<td class="white_cell">Bat-Mite</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			...
			<p><span class="bold">Note:</span> Bat-Mite's name may possibly be <i>ENYAW ECURB</i> - "Bruce Wayne" 
	...
	<tr>
		<td class="white_cell">Imp</td>
	</tr>
	<tr>
		<td class="black_cell">Legal Status</td>
	</tr>
	<tr>
		<td class="white_cell">Citizen of an alternate dimension.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Imp Dimension</p><br>
			<p>Possibly the 5<sup>th</sup> Dimension</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../teams/dc/BatFamily.php" target="_self">Bat Family</a></td>
	</tr>
	<tr>
		<td class="black_cell">Base of Operations</td>
	</tr>
	<tr>
		<td class="white_cell">Unnamed alternate dimension.</td>
	</tr>
	<tr>
		<td class="black_cell">Height</td>
	</tr>
	<tr>
		<td class="white_cell">2' 11"</td>
	</tr>
	<tr>
		<td class="black_cell">Weight</td>
	</tr>
	<tr>
		<td class="white_cell">47 lbs.</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">Extra-dimensional imp with an ability to alter reality.</td>
	</tr>
	<tr>
		<td class="black_cell">Accessories</td>
	</tr>
	<tr>
		<td class="white_cell">Utility Belt containing apparently no useful devices.</td>
	</tr>
	<tr>
		<td class="black_cell">Common Enemies</td>
	</tr>
	<tr>
		<td class="white_cell"><a href="../../villains/dc/Mxyzptlk.php" target="_self">Mr. Mxyzptlk</a></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Batman vol. 1</p>
			<p>Detective Comics vol. 1</p>
			<p>World's Finest Comics vol. 1</p><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell"><a href="../../issues/dc/1stBatMite.php" target="_self">Detective Comics #267</a> (May, 1959)</td>
	</tr>
	<tr>
		<td class="black_cell">Creator</td>
	</tr>
	<tr>
		<td class="white_cell">Bill Finger & Sheldon Moldoff</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="white_cell">
			<p>Claiming to be <a href="../../heroes/dc/BatmanI.php" target="_self">Batman</a>'s greatest fan, the curious and 
			immensely powerful imp from another dimension visits the Caped Crusader often as the mischievous 
			<span class="bold">Bat-Mite</span>.</p><br>
		</td>
	</tr>
</table>
