			...
			<div id="sliderb_container" style="position: relative; left: 2px; width: 904px; height: 150px; overflow: hidden;">
				<!-- Slides Container -->
				<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 899px; height: 100px; overflow: hidden;">
					<div>
					   <img u=image src="images/banner/01.png" />
						<div u="thumb">A comics-fan community featuring... </div>
					</div>
					<div>
					   <img u=image src="images/banner/02.png" />
						<div u="thumb">An extensive encyclopedia of comic-book characters</div>
					</div>
					<div>
					   <img u=image src="images/banner/03.png" />
						<div u="thumb">from publishers both large, small and independent.</div>
					</div>
					<div>
					   <img u=image src="images/banner/04.png" />
						<div u="thumb">An advice column for comic-book fans and collectors.</div>
					</div>
					<div>
					   <img u=image src="images/banner/05.png" />
						<div u="thumb">An interactive time-line of comic-book history.</div>
					</div>
					<div>
					...
					<div>
					   <img u=image src="images/banner/07.png" />
						<div u="thumb">Take the quiz to determine which superhero or villain you are.</div>
					</div>
					<div>
					   <img u=image src="images/banner/08.png" />
						<div u="thumb">Links to a wide community of comic book related sites.</div>
					</div>			
				</div>
