...
function scrollbutton(div_id)
{
	...
	else if (scroll_opt==0)
	{
		...
		// iPhone, windows phone 7 and android does not use mousedown so we have to add touchstart event
		...
		// iPhone, windows phone 7 and android does not use mouseup so we have to add touchend event
